...
# --- Configuration ----------------------------------------------------------
pkg_name <- "forplotR"                                   # package name
pkg_dir  <- "/Users/domingoscardoso/Library/Mobile Documents/com~apple~CloudDocs/Publications_Bioinformatics/forplotR_package_and_website/forplotR"
